      ...
      <div class="xl:container mx-auto px-6 md:px-12">
        <div class="mb-16 md:w-2/3 lg:w-1/2">
          ...
          <p class="text-gray-600 dark:text-gray-300">
            Take a schedule from our top reputed teacher and get a boost on your
            study.
          </p>
        </div>
        <div class="grid gap-6 px-4 sm:px-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="group relative rounded-3xl  space-y-6 overflow-hidden">
            ...
            <div class="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-white translate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
              <div>
                ...
                <span class="block text-sm text-gray-500">Senior Guidant</span>
              </div>
          ...
          <div class="group relative rounded-3xl  space-y-6 overflow-hidden">
            <img
              class="mx-auto h-[26rem] w-full grayscale object-cover object-top ransition duration-500 group-hover:scale-105 group-hover:grayscale-0"
              src="https://blog.insidescholar.org/wp-content/uploads/2021/12/depositphotos_229021444-stock-photo-happy-female-university-professor-outstretched-copy.jpg"
              alt="woman"
              loading="lazy"
              width="640"
              height="805"
          ...
          <div class="group relative rounded-3xl  space-y-6 overflow-hidden">
            <img
              ...
              src="https://www.tsinghua.edu.cn/en/js/f322-3.jpg"
              alt="woman"
              loading="lazy"
              width="640"
              height="805"
          ...
          <div class="group relative rounded-3xl  space-y-6 overflow-hidden">
            <img
              class="mx-auto h-[26rem] w-full grayscale object-cover object-top ransition duration-500 group-hover:scale-105 group-hover:grayscale-0"
              src="https://t4.ftcdn.net/jpg/01/99/36/81/360_F_199368197_CXhzovd2cgXhK3SR4xjUKNhTer8j5I87.jpg"
              alt="woman"
              loading="lazy"
              width="640"
              height="805"
...
export default ReputatedTeacher;
